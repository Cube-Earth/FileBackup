...
public class BeanBuilder2<T, U> {
	
	private static Map<String,BeanClass<?>> _clazzes = new HashMap<>();

	public static <T, U> BeanBuilder2<T, U> create() {
		return new BeanBuilder2<T, U>();
	}
	...
	public BeanBuilder2<T, U> clazz(Class<U> clazz) {
		_clazz = clazz;
		return this;
	}

	public BeanBuilder2<T, U> scope(String sScope) {
		_sScope = sScope;
		return this;
	}

	public BeanBuilder2<T, U> raiseExceptions(boolean bRaiseExceptions) {
		_bRaiseExceptions = bRaiseExceptions;
		return this;
	}
	
	public BeanBuilder2<T, U> adapter(Class<? extends IAdapter<T>> clazz) {
		_adapterClass = clazz;
		return this;
	}
	
	public BeanBuilder2<T, U> attributes(List<String> attributes) {
		_attributes = new ArrayList<>(attributes);
		return this;
	}

	public BeanBuilder2<T, U> attributes(String... saAttributes) {
